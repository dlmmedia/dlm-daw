...
import {ByteArrayInput, ByteArrayOutput, Float, Option, UUID} from "@dlm-daw/lib-std"
import {Compression} from "@dlm-daw/lib-dom"
import {BoxGraph, Editing, PointerField} from "@dlm-daw/lib-box"
