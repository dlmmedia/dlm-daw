...
import {FieldKey, NoPointers, PointerRules, PointerTypes} from "@dlm-daw/lib-box"
...
export class BoxForge<E extends PointerTypes> {
    ...
    #writeBoxVisitor(): void {
        ...
        file.addImportDeclarations([
            {moduleSpecifier: "@dlm-daw/lib-box", namedImports: ["VertexVisitor"]},
...
const STD_LIBRARY = "@dlm-daw/lib-std" as const
const BOX_LIBRARY = "@dlm-daw/lib-box" as const
...
class ClassWriter<E extends PointerTypes> {
    ...
    #writeClass(): void {
        ...
        if (noEdgeConstrains) {
            this.#imports.add("@dlm-daw/lib-box", "UnreferenceableType")
        }
