...
import {network, Promises} from "@dlm-daw/lib-runtime"
import {AudioData, Sample, SampleMetaData} from "@dlm-daw/studio-adapters"
import {SampleAPI} from "@dlm-daw/studio-core"

const username = "dlm-daw"
...
// Standard DLM DAW samples (considered to be non-removable)
export class OpenSampleAPI implements SampleAPI {
    static readonly ApiRoot = "https://api.dlm-daw.org/samples"
    static readonly FileRoot = "https://assets.dlm-daw.org/samples"
    ...
    async get(uuid: UUID.Bytes): Promise<Sample> {
        ...
        return Object.freeze({...sample, origin: "dlm-daw"})
    }
