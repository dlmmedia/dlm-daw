...
import {assert, ByteArrayInput, isInstanceOf, Option, UUID} from "@dlm-daw/lib-std"
...
export namespace ProjectDecoder {
    ...
    export const decode = (arrayBuffer: ArrayBufferLike): Skeleton => {
        ...
        assert(input.readInt() === ProjectDecoder.MAGIC_HEADER_OPEN, "Corrupt header. Probably not a DLM DAW project file.")
