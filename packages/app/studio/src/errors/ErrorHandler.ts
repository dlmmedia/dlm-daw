import {EmptyExec, Errors, Terminable, Terminator} from "@dlm-daw/lib-std"
import {AnimationFrame, Browser, Events} from "@dlm-daw/lib-dom"
...
export class ErrorHandler {
    ...
    processError(scope: string, event: Event): boolean {
        ...
        if (import.meta.env.PROD) {
            fetch("https://logs.dlm-daw.org/log.php", {
                method: "POST",
