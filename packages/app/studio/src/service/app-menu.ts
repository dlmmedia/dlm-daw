...
import {RouteLocation} from "@dlm-daw/lib-jsx"
import {EmptyExec, isAbsent, isDefined, panic, RuntimeNotifier, RuntimeSignal} from "@dlm-daw/lib-std"
import {Browser, Files, ModfierKeys} from "@dlm-daw/lib-dom"
import {SyncLogService} from "@/service/SyncLogService"
import {IconSymbol} from "@dlm-daw/studio-adapters"
import {CloudBackup, Colors, FilePickerAcceptTypes, ProjectSignals, Workers} from "@dlm-daw/studio-core"
...
export const initAppMenu = (service: StudioService) => {
    ...
    return MenuItem.root()
        .setRuntimeChildrenProcedure(parent => {
                parent.addMenuItem(
                    MenuItem.header({label: "dlm-daw", icon: IconSymbol.DLMDAW, color: Colors.green}),
